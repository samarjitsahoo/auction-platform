      ...
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col min-h-screen py-4 justify-center">
        <div className="bg-white mx-auto w-full h-auto px-2 flex flex-col gap-4 items-center py-4 justify-center rounded-md">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-1 gap-2 mx-auto">
              ...
              <div className="flex items-center gap-3">
                ...
                <input
                  ...
                  className="text-[14px] sm:text-[16px] file:py-1 file:px-2 file:rounded-md file:border file:border-gray-300 file:bg-white file:cursor-pointer"
                />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-4 mt-5">
              <label className="font-semibold text-xl md:2xl flex flex-col">
                Payment Method Details: (For Auctioneer Only)
              </label>
            ...
            <button
              className="bg-[#4749e9] w-full sm:w-[420px] lg:w-[640px] font-semibold hover:bg-[#2e2f9c] transition-all duration-300 text-xl py-2 px-4 rounded-md text-white mx-auto my-4"
              type="submit"
              disabled={loading}
            >
              {loading && "Registering..."}
            ...
            <p className="text-center text-sm text-stone-600">
              ...
              <Link
                ...
                className="text-[#4749e9] hover:underline"
              >
